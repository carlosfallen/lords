...
import {
    ...
    Loader2, QrCode, Unplug, PlugZap, RefreshCw, Smartphone,
} from 'lucide-react';
...
export default function Settings() {
    ...
    return (
        <div className="space-y-6 animate-fade-in max-w-3xl">
            ...
            {/* ── System ─────────────────────────────────────────────── */}
            <div className="card">
                <h3 className="text-sm font-semibold text-dark-200 mb-4 flex items-center gap-2"><Database size={14} className="text-imperio-400" /> Sistema</h3>
                <div className="grid grid-cols-2 gap-4 text-xs">
                    <div className="p-3 rounded-lg bg-dark-800/50"><span className="text-dark-500">Versão</span><p className="text-dark-200 font-mono mt-1">v1.0.0-beta</p></div>
                    <div className="p-3 rounded-lg bg-dark-800/50"><span className="text-dark-500">Runtime</span><p className="text-dark-200 font-mono mt-1">Bun v1.1.x</p></div>
                    <div className="p-3 rounded-lg bg-dark-800/50"><span className="text-dark-500">Banco</span><p className="text-dark-200 font-mono mt-1">PostgreSQL 16</p></div>
                    <div className="p-3 rounded-lg bg-dark-800/50"><span className="text-dark-500">Cache</span><p className="text-dark-200 font-mono mt-1">Redis 7.x</p></div>
                </div>
            </div>
        </div>
    );
